...
data_var = datetime.now()

print("{}/{}/{} - {}h{}'{}\"".format(data_var.day, data_var.month, data_var.year, data_var.hour, data_var.minute, data_var.second))

dia_usuario = int(input("Informe o dia: "))
mes_usuario = int(input("Informe o mês: "))
ano_usuario = int(input("Informe o ano: "))

data_var2 = datetime(ano_usuario, mes_usuario, dia_usuario)

# O dia da semana será exibido em inteiro, onde Segunda = 0 e Domingo é 6
print("{}/{}/{} - Dia da Semana: {}".format(data_var2.day, data_var2.month, data_var2.year, data_var2.weekday()))

diferenca = data_var - data_var2
