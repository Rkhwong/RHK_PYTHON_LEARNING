...
2 - Para cada vez que o 'for' rodar, cheque se o número principal que foi digitado é divisível por aquele número que está 
no for em questão.
...
verificarNum = int(input("Digite o numero a ser verificado :"))
contador = 0
for x in range(verificarNum):
    #print("{} % {} e Contador[{}]".format(verificarNum,x,contador))
    if verificarNum % ( x + 1 ) == 0:
        contador = contador + 1

#Check
if contador == 2:
    print("{} é Numero Primo".format(verificarNum))
else:
    print("{} e Numero Nao Primo".format(verificarNum))
