...
3 - Crie um programa que receba os valores base para que a aplicação funcione de forma que, se alterarmos o número de
 bateriais e a duração de cada bateria, o programa funcione sem precisar de mais modificações.
"""
"""# Resolução
...
numBaterias = int(input("Numero de Baterias :"))
duracaoBat = int(input("Duracao da Bateria :"))
#qtdPedras = int(input("Quantidade de Pedras :"))


pedras_por_minuto = 300 / (5 * 15)

pedras_lancadas = pedras_por_minuto * numBaterias * duracaoBat

print("A catapulta lançou {:.0f} pedras em {} baterias de {} minutos, cada.".format(pedras_lancadas, numBaterias, duracaoBat))